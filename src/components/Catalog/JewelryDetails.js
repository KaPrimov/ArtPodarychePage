...
import {loadJewelryDetails} from '../../models/product';
...
export default class Details extends Component {
    ...
    componentDidMount() {
        loadJewelryDetails(this.props.params.productId, this.onProductLoadSuccess);
        ...
        return (
            <div className="details-box">
                ...
                <div className="overview">
                    ...
                    <button id="add-to-cart" name={key} onClick={observer.addToCart} datatype='jewelry'><span name={key} datatype='jewelry'>Добавете</span>
                    </button>
                </div>
